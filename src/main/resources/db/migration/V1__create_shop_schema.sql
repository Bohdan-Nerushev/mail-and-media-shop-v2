-- V__create_shop_schema.sql
-- Repeatable Flyway migration for creating the database schema and tables
-- Підключення розширення для UUID
