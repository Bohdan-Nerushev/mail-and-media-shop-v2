...
(
    ...
    invoice_address_id INT REFERENCES addresses
(
    id
)
  ON DELETE RESTRICT,
    communication_details_id INT REFERENCES communication_details
(
    id
)
  ON DELETE RESTRICT,
...
(
    ...
    mail_product_id UUID NOT NULL REFERENCES mail_products
(
    id
)
  ON DELETE RESTRICT,
    partner_product_id UUID NOT NULL REFERENCES partner_products
(
    id
)
  ON DELETE RESTRICT
...
(
  ...
  ON DELETE RESTRICT,
    invoice_address_id INT NOT NULL REFERENCES addresses
(
    id
)
  ON DELETE RESTRICT,
