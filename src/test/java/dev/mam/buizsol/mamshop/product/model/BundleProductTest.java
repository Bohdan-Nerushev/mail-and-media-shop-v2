...
class BundleProductTest {
    ...
    void test3_CreateBundleProduct_NullComponents_ThrowsException(String nullCase) {
    ...
    void test5_BundleProduct_PolymorphicCalls() {
        ...
        PartnerProduct partner = createDefaultPartnerProduct("Base Cloud", Brand.WEB_DE, new BigDecimal("10.00"),
                new BigDecimal("3.50"));
    ...
    @Test
    @DisplayName("6. Success: Verify getters for components")
    void test6_BundleProduct_VerifyGetters() {
        StandardMailProduct mail = createDefaultStandardMailProduct("Mail", Brand.GMX, new BigDecimal("1.00"));
