...
//                ContractResponseDTO contractResponseDTO = CustomerTestFactory.createContractResponseDTO(contract.getId(),
//                                customerId, productId, contract.creationDate(), contract.getStatus());
//
