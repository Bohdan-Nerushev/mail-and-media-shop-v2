...
import com.unitedinternet.buizsol.mamshop.product.model.MailProduct;
...
//    }
    ...
    void shouldSuccessfullyUpdateMonthlyFeeToValidValue() {
        final Product product = createDefaultProduct(
                "Fee Test",
                Brand.MAIL_COM,
                "1.00",
    ...
    void shouldSuccessfullyUpdateMonthlyFeeToMinimumValidBoundaryValue() {
        final Product product = createDefaultProduct(
                "Boundary Test",
                Brand.GMX,
                "1.00",
    ...
    void shouldUpdateMonthlyFeeWithoutAffectingOtherProducts() {
    ...
    void shouldHandleLargeMonthlyFeeValues() {
        final Product product = createDefaultProduct(
                "Large Fee Test",
                Brand.WEB_DE,
                "1.00",
